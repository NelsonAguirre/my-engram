...
| `engram-documentation-updates` | When adding features, CLI commands, MCP tools, or any code change that needs documentation. | [`skills/documentation-updates/SKILL.md`](skills/documentation-updates/SKILL.md) |
